          ...
          <div className="space-y-4">
            {messages.map((message) => (
              ...
              >
                ...
                <div className="text-slate-300 prose prose-sm prose-invert max-w-none prose-p:my-2 prose-ul:my-2 prose-ol:my-2 prose-li:my-1 prose-headings:text-slate-200 prose-strong:text-white prose-code:text-pink-400 prose-pre:bg-slate-800 prose-pre:border prose-pre:border-slate-700">
