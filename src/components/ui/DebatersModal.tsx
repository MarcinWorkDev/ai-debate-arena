...
import { allAvailableAgents, type Agent } from '../../lib/agents'
                    ...
                    >
                      ...
                      <div className="relative flex-shrink-0">
                        <input
                          type="checkbox"
                          checked={isSelected}
                          onChange={() => !isDisabled && !cannotDeselect && toggleAgentSelection(agent.id)}
                      ...
                      <div className="flex items-start gap-3 flex-1 min-w-0">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="text-xs text-slate-400 mb-1">{agent.model}</div>
                          <div className="text-xs text-slate-500 leading-relaxed">{agent.persona}</div>
                        </div>
                      </div>
                    </motion.label>
                  )
